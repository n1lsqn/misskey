...
const defaultNoteVisibility = computed(store.makeGetterSetter('defaultNoteVisibility'));
const defaultNoteLocalOnly = computed(store.makeGetterSetter('defaultNoteLocalOnly'));
const rememberNoteVisibility = computed(store.makeGetterSetter('rememberNoteVisibility'));
const keepCw = computed(store.makeGetterSetter('keepCw'));
const filenameRandomize = computed(store.makeGetterSetter('filenameRandomize'));
